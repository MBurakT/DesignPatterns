...
namespace Visitor
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Manager fkymon = new Manager { Name = "Fkymon", Salary = 900 };

            Worker deneme = new Worker { Name="Deneme", Salary=800};
            Worker example = new Worker { Name = "Example", Salary = 700 };

            burak.Subordinates.Add(fkymon);
            fkymon.Subordinates.Add(deneme);
            fkymon.Subordinates.Add(example);
